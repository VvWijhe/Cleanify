...
MainWindow::~MainWindow() { delete ui_; Server_Exit();}
...
//Function to POST data to server with JSON
...
//Function for setting JSON with direction key, session key, wheel_speed key and brush_speed key
...
//Functions for what to do when buttons released: Stop driving roomba
